...
/*
  printf("Printing Milc long link\n");
  for(i=0; i<4; ++i){
  double* lngp = (double*)(&(lng[4*(128)+i]));
    printf("%lf %lf, %lf %lf, %lf %lf\n", lngp[0], lngp[1], lngp[2], lngp[3], lngp[4], lngp[5]);
    printf("%lf %lf, %lf %lf, %lf %lf\n", lngp[6], lngp[7], lngp[8], lngp[9], lngp[10], lngp[11]);
    printf("%lf %lf, %lf %lf, %lf %lf\n", lngp[12], lngp[13], lngp[14], lngp[15], lngp[16], lngp[17]);
    printf("\n");
  }
