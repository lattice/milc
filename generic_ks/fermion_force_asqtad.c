			       ...
			       int prec, fermion_links_t *fl )
{
  ...
  printf("Calling eo_fermion_force_oneterm_site\n");
			       ...
			       fermion_links_t *fl )
{
  ...
  printf("Calling eo_fermion_force_twoterms_hwv\n");
...
eo_fermion_force_twoterms( Real eps, Real weight1, Real weight2, 
  ...
  printf("Calling eo_fermion_force_twoterms\n");
				...
				int prec, fermion_links_t *fl )
{
  ...
  printf("Calling eo_fermion_force_twoterms_site\n");
...
fermion_force_asqtad_block( Real eps, Real *residues, 
			    ...
			    int prec, fermion_links_t *fl ) 
{
  printf("Calling fermion_Force_asqtad_block\n");
  int j;
			    ...
			    fermion_links_t *fl ) 
{
  ...
  printf("Calling fermion_force_asqtad_multi\n");
  /* prec is ignored for now */
