...
dumpmat( &(W_unitlink[AB_OUT_ON_LINK][AB_OUT_ON_SITE]) );
  ...
  case UNITARIZE_ANALYTIC:
    ...
    FORALLFIELDSITES_OMP(i,private(tmat,dydv,dydagdv,dwdv,dwdagdv,m,n,k,l,force,force_tmp,ftmp) reduction(+:nflops_all_sites) ){
      for(dir=XUP;dir<=TUP;dir++){
...
fn_fermion_force_multi_hisq_wrapper_mx_cpu( info_t *info, Real eps, Real *residues, 
				     ...
				     fermion_links_t *fl)
{
  printf("Calling fn_fermion_force_multi_hisq_wrapper_mx_cpu\n");
					   ...
					   fermion_links_t *fl)
{
  ...
  printf("Calling fn_fermion_force_multi_hisq_wrapper_mx_gpu\n");
