      ...
      if(i_gamma_corr == 0 || gamma_table[i_gamma_corr].gout != old_gamma_out)
	{
	  ...
	  FORALLSITES(i,s) {
	    ...
	    if( i < loopend-FETCH_UP){
	      prefetch_WWWW(
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src1))->d[0]),
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src1))->d[1]),
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src1))->d[2]),
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src1))->d[3]));
	      prefetch_WWWW(
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src2))->d[0]),
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src2))->d[1]),
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src2))->d[2]),
		    &(((spin_wilson_vector *)F_PT(s+FETCH_UP,src2))->d[3]));
	    }
